    ...
    <Show when={props.open}>
      ...
      >
        ...
        >
          ...
          >
            <span style={{ "font-weight": "700", "font-size": "15px", "letter-spacing": "0.02em" }}>Keyboard Shortcuts</span>
            <span style={{ "font-size": "11px", opacity: "0.55" }}>Press ? to close</span>
          </div>

          <div style={{ padding: "12px 16px", display: "grid", "grid-template-columns": "140px 1fr", gap: "10px 16px" }}>
            {shortcuts.map((s) => (
