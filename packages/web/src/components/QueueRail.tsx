          ...
          <For each={items()}>
            {(text, i) => (
              <div class="card" style={{ padding: "9px 11px", display: "flex", gap: "9px", "align-items": "flex-start" }}>
                <div style={{ "font-family": "var(--font-mono)", "font-size": "var(--fs-2xs)", color: "var(--fg-faint)", "margin-top": "2px", flex: "none", width: "22px" }}>
                  {i() + 1}
                </div>
                <div style={{ flex: "1", "min-width": "0" }}>
                  <div style={{ "font-size": "var(--fs-sm)", color: "var(--fg)", "line-height": "1.45", "word-break": "break-word" }}>
                    {preview(text)}
                  </div>
                </div>
                <div style={{ display: "flex", "flex-direction": "column", gap: "4px", flex: "none" }}>
                  <button
                    ...
                    disabled={i() === 0}
                    title="Move up"
                    style={{ padding: "2px 6px", "font-size": "var(--fs-xs)", border: "1px solid var(--border)", "border-radius": "var(--r-full)" }}
                  >
                    ↑
                  </button>
                  <button
                  ...
                  <button
                    ...
                    onClick={() => cancel(i())}
                    title="Cancel item"
                    style={{ padding: "2px 6px", "font-size": "var(--fs-xs)", border: "1px solid var(--border)", "border-radius": "var(--r-full)", color: "var(--danger)" }}
                  >
                    ✕
                  </button>
                </div>
